...
import static io.amps.decaf.structure.Instruction.*;
...
public class InstructionSets {
	...
	public static final Set<Instruction> METHOD_INSNS = Collections
			.unmodifiableSet(new HashSet<>(Arrays.asList(new Instruction[] {
					invokedynamic, invokeinterface, invokespecial,
					invokestatic, invokevirtual })));
	public static final Set<Instruction> LDC_INSNS = Collections
			.unmodifiableSet(new HashSet<>(Arrays.asList(new Instruction[] {
					ldc, ldc2_w, ldc_w })));
	public static final Set<Instruction> ISTORE_INSNS = Collections
			.unmodifiableSet(new HashSet<>(Arrays.asList(new Instruction[] {
					istore, istore_0, istore_1, istore_2, istore_3 })));
	public static final Set<Instruction> ILOAD_INSNS = Collections
			.unmodifiableSet(new HashSet<>(Arrays.asList(new Instruction[] {
					iload, iload_0, iload_1, iload_2, iload_3 })));

	public static final Set<Instruction> ASTORE_INSNS = Collections
			.unmodifiableSet(new HashSet<>(Arrays.asList(new Instruction[] {
					astore, astore_0, astore_1, astore_2, astore_3 })));
	public static final Set<Instruction> ALOAD_INSNS = Collections
			.unmodifiableSet(new HashSet<>(Arrays.asList(new Instruction[] {
